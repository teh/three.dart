...
class WireframeHelper extends Line {
  factory WireframeHelper(Mesh object, [int hex = 0xffffff]) {
    ...
    } else if (object.geometry is BufferGeometry && (object.geometry as BufferGeometry).attributes.containsKey("index")) {
    ...
    return new Line(geometry, new LineBasicMaterial(color: hex), LINE_PIECES);
  }
}