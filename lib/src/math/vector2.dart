...
class Vector2 {
  ...
  /*
   * Additions based on three.js vector2
   */
  
  /// Constructs a vector with components [1.0, 1.0].
  Vector2.one() { setValues(1.0, 1.0); }
  
  /// Constructs a vector with components [-1.0, -1.0].
  Vector2.minusOne() { setValues(-1.0, -1.0); }
  
  /// Constructs a vector with components [0.0, 1.0].
  Vector2.up() { setValues(0.0, 1.0); }
  
  /// Constructs a vector with components [0.0, -1.0].
  Vector2.down() { setValues(0.0, -1.0); }
  
  /// Constructs a vector with components [1.0, 0.0].
  Vector2.right() { setValues(1.0, 0.0); }
  
  /// Constructs a vector with components [-1.0, 0.0].
  Vector2.left() { setValues(-1.0, 0.0); }
