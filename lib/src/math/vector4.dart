...
class Vector4 {
  ...
  Vector4(double x_, double y_, double z_, double w_) : storage = new Float32List(4) {
    setValues(x_, y_, z_, w_);
  }

  /// Initialized with values from [array] starting at [offset].
  Vector4.array(List<double> array, [int offset=0]) : storage = new Float32List(4) {
    int i = offset;
    storage[0] = array[i+0];
    storage[1] = array[i+1];
    storage[2] = array[i+2];
  ...
  /// Copy of [other].
  Vector4.copy(Vector4 other) : storage = new Float32List(4) {
    setFrom(other);
  }
  ...
  /*
   * Additions based on three.js vector4
   */
  
  /// Splat [arg] into all lanes of the vector.
  Vector4.splat(double arg) : storage = new Float32List.fromList([arg, arg, arg, arg]);
  ...
  Vector4 lerp(Vector4 other, double t) {
    ...
    storage[3] += (other.w - storage[3]) * t;
    return this;
  }
  
  Vector4 applyMatrix4(Matrix4 arg) {
    storage[0] = arg[0] * storage[0] + arg[4] * storage[1] + arg[8] * storage[2] + arg[12] * storage[3];
    storage[1] = arg[1] * storage[0] + arg[5] * storage[1] + arg[9] * storage[2] + arg[13] * storage[3];
    storage[2] = arg[2] * storage[0] + arg[6] * storage[1] + arg[10] * storage[2] + arg[14] * storage[3];
    storage[3] = arg[3] * storage[0] + arg[7] * storage[1] + arg[11] * storage[2] + arg[15] * storage[3];
    return this;
  }
  
  double lengthManhattan() => storage[0].abs() + storage[1].abs() + storage[2].abs() + storage[3].abs();
}
